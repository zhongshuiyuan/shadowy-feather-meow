...
define([
    'jquery', 'underscore', 'sfLayoutBase', 'text!./nwcLayout.html'
], function(
    $, _, SfLayoutBase, NwcLayoutTpl
) {
    var VERSION = '0.0.1';
    ...
    var NwcLayout = SfLayoutBase.extend({
        ...
        showMask: function(visible){
            var me = this;
            var $m = me.el.find('#nwcLayout_mask');
            if(visible){
                $m.fadeIn();
            }else{
                $m.fadeOut();
